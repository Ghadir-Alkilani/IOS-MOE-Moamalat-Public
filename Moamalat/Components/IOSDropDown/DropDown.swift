...
//  FollowUp
//
//  Created by Mostafa Gadallah on 12/07/1442 AH.
//
...
open class DropDown : UITextField{
    ...
    @IBInspectable public var rowTextColor: UIColor = UIColor(named: "MoamalatDarkBrown")!
    @IBInspectable public var selectedRowColor: UIColor = UIColor(named: "MoamalatLightGray")!
