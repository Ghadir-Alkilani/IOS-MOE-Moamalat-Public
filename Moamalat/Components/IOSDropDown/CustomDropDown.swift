...
//  FollowUp
//
//  Created by Ghadir kilani on 18/10/1442 AH.
//
...
class CustomDropDown: UITextField {
    ...
    @IBInspectable public var rowTextColor: UIColor = .MoamalatDarkBlue
    @IBInspectable public var selectedRowColor: UIColor = .MoamalatLightBlue
        ...
        fileprivate  var dataArray = [DropDownModel]()
    ...
    //                }
        ...
        @IBInspectable public var arrowSize: CGFloat = 25 {
            didSet{
        ...
        func setupArrow() {
            ...
            let rightView = UIView(frame: CGRect(x: 0.0, y: 5.0, width: size, height: size))
    ...
    extension CustomDropDown: UITableViewDataSource {
        ...
        public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cellIdentifier1 = "DropDownCell"

            var cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier1)
            ...
            cell!.textLabel!.text = optionArray[indexPath.row].valueAr
            cell!.accessoryType = (indexPath.row == selectedIndex) && checkMarkEnabled  ? .checkmark : .none
            cell!.selectionStyle = .none
            cell?.textLabel?.font = UIFont.dINNextLTArabicRegular(fontSize: 13)
    ...
    extension CustomDropDown: UITableViewDelegate {
        public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            let selectedText = self.dataArray[self.selectedIndex].valueAr!
    ...
    //        })
            ...
            let selectedTextId = self.dataArray[self.selectedIndex].id
            self.selectedItem = self.dataArray[self.selectedIndex]
           // print("ddd \(selectedTextId)")
            didSelectCompletion(selectedText, Int(selectedTextId!) , Int(selectedTextId!) )
    ...
    class Arrow1: UIView {
        ...
        var arrowColor:UIColor = .green {
            didSet{
                shapeLayer.fillColor = arrowColor.cgColor
            }
        }

        var position: Position1 = .down {
            didSet{
                switch position {
                case .left:
